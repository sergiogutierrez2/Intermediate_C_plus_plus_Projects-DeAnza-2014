...
/* ************************************Main******************************************
*Calls other functions, defines 5 variables, Car instances and tests their equality.*
*************************************************************************************/
int main ()
{
    ...
    Car car1(reportingMark, carNumber, kind, loaded, destination); // This is initialized with the user's input.
    ...
    car1.output(); // Sending Values of car1 to the output function
    car2.output(); // Sending Values of car2 to the output function
    car3.output(); // Sending Values of car3 to the output function

    //Code provided by instructor to test the equality of the 3 instances of Car
    if (car1 == car2)
...
Process returned 0 (0x0)   execution time : 23.395 s
